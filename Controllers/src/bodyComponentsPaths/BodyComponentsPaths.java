...
public class BodyComponentsPaths
{
    ...
    public static String SMALL_GRAPH_PNG = "/resourcers/graphviz/small_graph.png";
    public static String BIG_GRAPH_PNG = "/resourcers/graphviz/big_graph.png";
