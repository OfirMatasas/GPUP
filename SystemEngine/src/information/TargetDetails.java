...
public class TargetDetails {
    ...
    public TargetDetails(int num, String targetName, String position, int directDependsOn, int allDependsOn, int directRequiredFor, int allRequiredFor, int serialSets) {
        this.num = num;
